                    ...
                    <div class="row clearfix">
                        ...
                        <div class="service-block-two col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp"
                            ...
                            <div class="inner-box">
                                ...
                                <h5><a href="<?php echo e(route('website-development-company')); ?>">WEBSITE<br>DEVELOPMENT</a></h5>
                                ...
                                <div class="link-box"><a href="<?php echo e(route('website-design-company')); ?>"><span class="fa fa-angle-right"></span></a></div>
                            </div>
                        </div>
                        ...
                        <div class="service-block-two col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp"
                            ...
                            <div class="inner-box">
                                ...
                                <h5><a href="<?php echo e(route('digital-marketing-company')); ?>">DIGITAL<br>MARKETING</a></h5>
                                ...
                                <div class="link-box"><a href="<?php echo e(route('seo-company-gurgaon')); ?>"><span class="fa fa-angle-right"></span></a></div>
                            </div>
                        </div>
                        ...
                        <div class="service-block-two col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp"
                            ...
                            <div class="inner-box">
                                ...
                                <h5><a href="<?php echo e(route('ecommerce-services')); ?>">E-COMMERCE<br>SOLUTION</a></h5>
                                ...
                                <div class="link-box"><a href="<?php echo e(route('ecommerce-services')); ?>"><span class="fa fa-angle-right"></span></a></div>
                            </div>
                        </div>
                        ...
                        <div class="service-block-two col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp"
                            ...
                            <div class="inner-box">
                                ...
                                <h5><a href="<?php echo e(route('graphic-designing-company')); ?>">GRAPHIC<br> DESIGNING</a></h5>
                                ...
                                <div class="link-box"><a href="<?php echo e(route('graphic-designing-company')); ?>"><span class="fa fa-angle-right"></span></a></div>
                            </div>
                        </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box">
                            ...
                            <h6><a href="<?php echo e(route('website-design-company')); ?>">Website <br>Design</a></h6>
                        </div>
                    </div>
                    <!--Service Block-->
                    <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box">
                            ...
                            <h6><a href="<?php echo e(route('website-development-company')); ?>">Website<br>Development</a></h6>
                        </div>
                    </div>
                    <!--Service Block-->
                    <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box">
                            ...
                            <h6><a href="<?php echo e(route('digital-marketing-company')); ?>">Digital <br>Marketing</a></h6>
                        </div>
                    </div>
                    <!--Service Block-->
                    <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box">
                            ...
                            <h6><a href="<?php echo e(route('seo-company-gurgaon')); ?>">SEO<br>Services</a></h6>
                        </div>
                    </div>
                    <!--Service Block-->
                    <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box">
                            ...
                            <h6><a href="<?php echo e(route('graphic-designing-company')); ?>">Graphic<br>Designing</a></h6>
                        </div>
                    </div>
                    <!--Service Block-->
                    <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-box">
                            ...
                            <h6><a href="<?php echo e(route('ecommerce-services')); ?>">E-commerce<br>Solutions</a></h6>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/amit/Desktop/newfolder/infoshala/resources/views/services.blade.php ENDPATH**/ ?>