...
<head>
    <meta charset="utf-8">
    <title>Infoshala - Best Digital Marketing agency in Gurgaon| Web Development Company in Gurgaon| About Us</title>
...
<?php echo $__env->make('include/navbar1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="auto-container">
                <div class="row clearfix">
                    ...
                    <div class="right-col col-lg-6 col-md-12 col-sm-12">
                        <div class="inner">
                            <div class="sec-title">
                                <h2>ABOUT<br><span class="dot">INFOSHALA</span></h2>

                                <div class="lower-text">INFOSHALA is the best website design & Digital marketing company in Gurgaon India and worldwide. We have been providing explanations to customers worldwide for over 1 year and claim our broad experience in website designing and digital marketing projects. With over 100+ website design and digital marketing projects executed, we live and breathe the network.</div>
                                <p class="about-me-one__qoute">WE MAKE AN EFFORT WITH OUR CLIENTS FOR THEIR CONTINUOUS SUCCESS.</p>
                            </div>
                            <div class="features">
                                <div class="row clearfix">
 ...
 <section class="facts-section jarallax" data-jarallax data-speed="0.3" data-imgPosition="50% 80%">
            <img src="assets/images/background/marketing.jpg" alt="website design & seo services gurgaon" title="website design & seo services gurgaon" class="jarallax-img">
            <div class="auto-container">
                ...
                <div class="outer-container">
                    <div class="row clearfix">
                            ...
                            <div class="inner">
                                <div class="col-header">
                                    <div class="header-inner">
                                        <span>We’re Committed To Carry High-Quality Projects.</span>
                                    </div>
                                </div>
                                <div class="features">
                                    <div class="feature">
                                        <div class="count"><span>01</span></div>
                                        <h5>TOTAL DESIGN CHOICE FOR EVERYBODY</h5>
                                        <div class="sub-text">features</div>
                                    </div>
                                    <div class="feature">
                                        <div class="count"><span>02</span></div>
                                        <h5>BASIC GUIDELINES FOR RUNNING A WEBSITE AGENCY</h5>
                                        <div class="sub-text">features</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="right-col col-xl-7 col-lg-6 col-md-12 col-sm-12">
                            <div class="inner">
                                <div class="sec-title">
                                    <h2>We’re important by more<br>than 100+ cilents<span class="dot">.</span></h2>
                                    <div class="lower-text">Our humble reason to exist is to benefit you to become Successful. It’s as humble as that. So when we Develop a Website and Digital Marketing for you, we do it keeping that impartial in mind - and we prepare it to repair well. Our top-secret sauce for success is – we take efforts in understanding what your clients need from you and exceed their outlooks. We are sure that would certainly pleasure you!</div>
                                </div>
                                <div class="featured-block-two clearfix">
                                    <div class="image"><img src="assets/images/resource/featured-image-17.jpg" alt="" title="" ></div>
                                    <div class="text">
                                        <ul>
                                            <li>Fixed Estimates</li>
                                            <li>Loyal Teams</li>
                                            <li>Reimbursement As You Go</li>
                                            <li>Staff Growth & Offshore Teams</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="testimonials-carousel owl-theme owl-carousel">
                        <div class="testi-block">
                            <div class="inner">
                                ...
                                <div class="info">
                                    <div class="image"><a href="<?php echo e(route('team')); ?>"><img src="assets/images/resource/author-1.jpg"
                                                alt=""></a></div>
                        ...
                        <div class="testi-block">
                            <div class="inner">
                                <div class="icon"><span>“</span></div>
                                <div class="info">
                                    <div class="image"><a href="<?php echo e(route('team')); ?>"><img src="assets/images/resource/author-2.jpg"
                                                alt=""></a></div>
                        ...
                        <div class="testi-block">
                            <div class="inner">
                                <div class="icon"><span>“</span></div>
                                <div class="info">
                                    <div class="image"><a href="<?php echo e(route('team')); ?>"><img src="assets/images/resource/author-3.jpg"
                                                alt=""></a></div>
                ...
                <div class="row">
                        ...
                        <div class="team-card-three">
                            <div class="team-card-three__inner">
                                <div class="team-card-three__image">
                                    <img src="assets/images/resources/team-1.jpg" alt="">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-card-three">
                            <div class="team-card-three__inner">
                                <div class="team-card-three__image">
                                    <img src="assets/images/resources/team-3.jpg" alt="">
                                </div><!-- /.team-card-three__image -->
                                <div class="team-card-three__content">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-card-three">
                            <div class="team-card-three__inner">
                                <div class="team-card-three__image">
                                    <img src="assets/images/resources/team-4.jpg" alt="">
                                </div><!-- /.team-card-three__image -->
                                <div class="team-card-three__content">
        ...
        <section class="parallax-section jarallax" data-jarallax data-speed="0.3" data-imgPosition="50% 80%">
            ...
            <div class="auto-container">
                <div class="content-box">
                    ...
                    <h2>Great things in a corporate are never done by one individual.<span>They’re done by a team of persons.</span></h2>
                </div>
            </div>
        </section>
        <!-- End Funfacts Section -->
...
<?php /**PATH /home/amit/Desktop/newfolder/infoshala/resources/views/about.blade.php ENDPATH**/ ?>