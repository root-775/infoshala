...
<head>
    <meta charset="utf-8">
    <title>INFOSHALA | Website Development Company in Gurgaon</title>
    <!-- Stylesheets -->
                ...
                <div class="row clearfix">
                    ...
                    <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="0ms"
                        ...
                        <div class="inner-box">
                            ...
                            <h6 style="text-decoration-line: underline;"><a href="<?php echo e(route('website-design-company')); ?>">WEBSITE <br>DESIGN</a></h6>
                              <div class="text" style="text-align:justify;font-weight:300">Our skilled<a href="<?php echo e(route('website-design-company')); ?>" title="website designer gurgaon"> website designer</a> and developer team certify that deliver brilliant website services. we effort on high-end projects and the latest technologies. Contact us now to discuss your project and more.</div>
                        </div>
                    </div>
                    <!--Service Block-->
                    <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInLeft"
                        ...
                        <div class="inner-box">
                            ...
                            <h6 style="  text-decoration-line: underline;"><a href="<?php echo e(route('website-development-company')); ?>">WEBSITE<br>DEVELOPMENT</a></h6>
                             <div class="text" style="text-align:justify;font-weight:300">We take website development as an all-inclusive process. We attempt to develop your website that looks great and performs at all levels. Connect us now to converse about your project.</div>
                        </div>
                    </div>
                    <!--Service Block-->
                    <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="0ms"
                        ...
                        <div class="inner-box">
                            ...
                            <h6 style="  text-decoration-line: underline;"><a href="<?php echo e(route('website-development-company')); ?>">WORDPRESS<br>WEBSITE</a></h6>
                             <div class="text" style="text-align:justify;font-weight:300">WordPress Website Design Helps to achieve your satisfaction by yourself. It’s Easy to achieve because of its context.</div>
                        </div>
                    </div>
                    <!--Service Block-->
                    <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInLeft"
                        ...
                        <div class="inner-box">
                            ...
                            <h6 style="  text-decoration-line: underline;"><a href="<?php echo e(route('website-development-company')); ?>">PHP<br>WEBSITE</a></h6>
                             <div class="text" style="text-align:justify;font-weight:300">PHP website development to deliver your project as per your requirement. Contact us now to discuss your plan.</div>
                        </div>
                    </div>
                    <!--Service Block-->
                    <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInLeft"
                        ...
                        <div class="inner-box">
                            ...
                            <h6 style="text-decoration-line: underline;"><a href="<?php echo e(route('ecommerce-services')); ?>">E-commerce<br>Website</a></h6>
                             <div class="text" style="text-align:justify;font-weight:300">We make high-end modified E-commerce websites template ready to upraise your brand’s awareness using a skill like WordPress etc. </div>
                        </div>
                    </div>
                    <!--Service Block-->
                    <div class="service-block col-xl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInLeft"
                        ...
                        <div class="inner-box">
                            ...
                            <h6 style="  text-decoration-line: underline;"><a href="<?php echo e(route('contact')); ?>">Custom<br>Developer</a></h6>
                             <div class="text" style="text-align:justify;font-weight:300">Our skilled team conveys ideas to life by creating a good-looking user interface website to build the value of your brand in the marketplace.</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="auto-container">
                <div class="row clearfix">
                    ...
                    <div class="text-column col-xl-6 col-lg-12 col-md-12 col-sm-12">
                            <div class="sec-title">
                                <h2><span class="dot">Website Technology</span></h2>
                            </div>
        ...
        <section class="call-to-section-two alternate">
            <div class="auto-container">
                <div class="inner clearfix">
                    ...
                    <div class="link-box">
                        <a class="theme-btn btn-style-two" href="<?php echo e(route('contact')); ?>">
                            <i class="btn-curve"></i>
...
<?php /**PATH /home/amit/Desktop/newfolder/infoshala/resources/views/website-development-company.blade.php ENDPATH**/ ?>