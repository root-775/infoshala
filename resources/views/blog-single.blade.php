                        ...
                        <div class="blog-details">
                            ...
                            <div class="post-details">
                                ...
                                <div class="info-row clearfix">
                                    <div class="tags-info"><strong>Tags:</strong> <a href="{{ route('index') }}">Business</a>, <a
                                            href="{{ route('digital-marketing-company') }}">Agency</a>, <a href="{{ route('website-development-company') }}">Technology</a></div>
                                    <div class="cat-info"><strong>Category:</strong> <a href="{{ route('index') }}">Business</a>, <a
                                            href="{{ route('digital-marketing-company') }}">Agency</a></div>
                                </div>
                            </div>
