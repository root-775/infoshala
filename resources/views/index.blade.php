                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="auto-container">
                            <div class="slider-six__content">
                                ...
                                <!-- /.slider-six__title -->
                                <a href="{{ route('website-development-company') }}" class="slider-six__btn thm-btn__six">Discover More</a>
                                <!-- /.thm-btn__six -->
                            </div>
                            <!-- /.slider-six__content -->
                        </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="auto-container">
                            <div class="slider-six__content">
                                ...
                                <!-- /.slider-six__title -->
                                <a href="{{ route('digital-marketing-company') }}" class="slider-six__btn thm-btn__six">Discover More</a>
                                <!-- /.thm-btn__six -->
                            </div>
                            <!-- /.slider-six__content -->
                        </div>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="auto-container">
                            <div class="slider-six__content">
                                ...
                                <!-- /.slider-six__title -->
                                <a href="{{ route('graphic-designing-company') }}" class="slider-six__btn thm-btn__six">Discover More</a>
                                <!-- /.thm-btn__six -->
                            </div>
                            <!-- /.slider-six__content -->
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="about-seven__content">
                            ...
                            <a href="{{ route('about') }}" class="about-seven__btn thm-btn__six">Discover More</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4 wow fadeInUp" data-wow-duration="1500ms">
                        <div class="service-six__item">
                            ...
                            <div class="service-six__content">
                                ...
                                <h3 class="service-six__title"><a href="{{ route('website-development-company') }}">Web Development</a></h3>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4 wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="300ms">
                        <div class="service-six__item">
                            ...
                            <div class="service-six__content">
                                ...
                                <h3 class="service-six__title"><a href="{{ route('digital-marketing-company') }}">Digital Marketing</a>
                                </h3>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-4 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="service-six__item">
                            ...
                            <div class="service-six__content">
                                ...
                                <h3 class="service-six__title"><a href="{{ route('graphic-designing-company') }}">Graphic Designing</a>
                                </h3>
